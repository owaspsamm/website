...
* a [Getting Started guide](/docs/getting-started/) with different steps to improve your secure software practice
...
{{< figure src="/img/pages/SAMM_v2_overview.svg" alt="SAMM v2 model overview" type="diagram" >}}
