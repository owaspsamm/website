...
{{< figure src="/img/blog/undraw_hacker_mind_6y85.png" alt="SAMM assessment" >}}
...
**How can SAMM help identify systems impacted by a vulnerability like Log4Shell and then take actions to remediate it?**
...
{{< figure src="/img/blog/security.png" alt="SAMM assessment" >}}
...
- [A good explanation](https://nakedsecurity.sophos.com/2021/12/13/log4shell-explained-how-it-works-why-you-need-to-know-and-how-to-fix-it/) of Log4Shell from naked security by Sophos
- [Some input](https://blog.sonatype.com/ftc-warning-in-wake-of-log4j?hsLang=en-us) on why software composition analysis tools might be important to identify and track library usage
- A [list of recommendations and patching pointers](https://www.reddit.com/r/blueteamsec/comments/rd38z9/log4j_0day_being_exploited/)
