...
We are excited to announce that each OWASP-SAMM stream now uses [OpenCRE.org](https://opencre.org) to link to other standards and guidelines.
...
[Guidance Google Doc](https://docs.google.com/document/d/1weyNHuAm3XYOYinJPbnEBQV1k48r6Oi3JxZVi2cgy2g/edit)
...
If you want to join our Slack channel but the direct link doesn’t work, you need an invitation. Get it [here](https://owasp.org/slack/invite).
...
* Join our  [Slack channel](https://owasp.slack.com/messages/C0VF1EJGH), where you'll meet other users, ask questions, give feedback, and be in the loop of all things SAMM.
