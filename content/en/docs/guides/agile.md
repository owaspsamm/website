...
description: "How to implement SAMM security practices in an Agile environment: best practices, pitfalls, and practical examples"
weight: 10
toc: true
aliases:
  - /guidance/agile/
...
* **[Security Testing](#security-testing)**
    * Agile testing
* **[Requirements-driven Testing](#requirements-driven-testing)**
    * Abuse stories

{{< figure src="/img/pages/Agile_Guidance.png" alt="Agile guidance in relation to the SAMM Model" type="diagram" caption="Agile guidance items in relation to the SAMM Model" >}}
...
{{< figure src="/img/pages/SAMMAgileRequirementsProcess.png" alt="SAMM Agile requirements process" type="diagram" caption="Overview of the software development process and the flow of requirements" >}}
...
<a name="requirements-driven-testing"></a>
