---
title: FAQ
description: "Frequently asked questions about the SAMM model, assessments, and community"
weight: 10
toc: true
aliases:
  - /resources/faq/
...
This content is part of our [data files on GitHub](https://github.com/owaspsamm/core/tree/develop/model). We'll work on having it available on the website soon.
...
You can try with the direct link to our [Slack channel](https://owasp.slack.com/messages/C0VF1EJGH). If that doesn't work, you need an invitation. Click [here](https://owasp.org/slack/invite) to get it.
